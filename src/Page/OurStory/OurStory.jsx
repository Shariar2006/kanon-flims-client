...
const OurStory = () => {
    return (
        <div>
            <h1 className="text-center text-5xl font1 text-white pt-8 uppercase border-b border-[#FFDD6B] w-72 mx-auto">Our Story</h1>
            <div className="hero min-h-[80vh]">
                <div className="max-w-4xl z-0 flex items-center justify-center flex-col lg:flex-row-reverse bg-gradient-to-r from-[#101010c6] to-[#494949a9]">
                    ...
                    <div className="text-center text-[#FFDD6B] px-3 font2">
